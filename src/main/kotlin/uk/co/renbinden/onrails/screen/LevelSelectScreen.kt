        ...
        engine.add(LevelSelectButton(assets, 368.0, 300.0) {
            ...
            level(
                ...
                timeline(assets) {
                    ...
                    showText(avatars.angelaFunikular, "...")
                    showText(avatars.angelaFunikular, "...")
                    showText(avatars.angelaFunikular, "...Junction Function Interpsyche Freightway. We are a...proud company. I expect you to give your very best on this and every job.")
                    showTextWithOptions(avatars.angelaFunikular, "Do you think you can.........handle it?", "Y...yeah.", "Yes Ma'am!")
                    showText(avatars.angelaFunikular, "Groovy. I will....see you.......................................................again.")
                    removeAvatar(avatars.angelaFunikular)
                    ...
                    createAvatar(avatars.dianaBogie, 450.0, 100.0)
                    showTextWithOptions(avatars.dianaBogie, "U-uhm...hi...I was wondering if you'd be able to help me?", "Sure can!", "I can certainly try.")
                    showText(avatars.dianaBogie,"T...That's great. My name's Diane Bogie, and I...look I'm in kind of a mess right now, and...I dunno. It feels like I could really just feeling my feelings.")
                    showTextWithOptions(avatars.dianaBogie,"You get what I mean?", "Go on...?", "I think so. Catharsis, right?")
                    showText(avatars.dianaBogie,"Yeah, so. I guess...can you make it like...sad? And super aggressive? That's what I've been feeling. Just a bunch of sad, bad and angry feelings.")
                    showTextWithOptions(avatars.dianaBogie, "Is that something you can do?", "Sure can.", "Of course.")
                    showText(avatars.dianaBogie, "Thanks. This'll be good for me I think.")
                    showText(null, "Diana smiles gratefully as you both board the train.")
                },
                assets.images.backgroundStation3,
                timeline(assets) {
                    createAvatar(avatars.dianaBogie, 450.0, 100.0)
                    showTextWithOptions(avatars.dianaBogie, "Diana doesn't say much, but she smiles at you as she disappears.", "Say goodbye.", "Just smile back.")
                    showText(null, "As she leaves, you hear a loud crack of thunder.")
                    removeAvatar(avatars.dianaBogie)
                    createAvatar(avatars.jasonHardrail, 450.0, 100.0)
                    showText(avatars.jasonHardrail, "Heeeeeeey newbie! I'm back!")
                    showText(null, "Jason is back.")
                    showTextWithOptions(avatars.jasonHardrail, "Hahaaaa, how'd it GO!? Lulu said you were pretty good!", "I think I'm getting the hang of it", "What ARE you?")
