        ...
        engine.add(LevelSelectButton(assets, 128.0, 300.0) {
            ...
            level(
                ...
                timeline(assets) {
                    ...
                    showText(avatar.jasonHardrail, "Haha, yeah it takes a lot to get used to. Bet you're a natural though.")
                    ...
                    showTextWithOptions(avatar.jasonHardrail, "You with me so far?" "Hey, I didn't sign up for this!" "Right on, how do we do it?")
                    showText(avatar.jasonHardrail, "Yeah, I hear ya I hear ya. We don't really get a say in who gets the job, but I gotta say it's a pretty sweet gig. And you get your own ride.")
                    showText(avatar.jasonHardrail, "Speakin' of, we gotta get you set up. You seem funky, but we both got work to do, so listen up newbie.")
                    showText(null, "Jason gets this real intense look all of a sudden.")
                    showText(avatar.jasonHardrail, "You're now a conductor of your very own Dreamtrain! You're gonna ride the rails of Dreamrealm, and give your passengers the perfect dreams!")
                    showText(avatar.jasonHardrail, "Don't worry, kid, it's waaay easier than it sounds. The engine'll move forward on it's own. When you're reaching a junction, hold either A or D depending on if you wanna go left or right.")
                    showText(avatar.jasonHardrail, "Out there in the tracks, you'll find a bunch of floatin' emotions called Dream Bubbles. These wild vibes are out to make your dreams real good, or real bad depending.")
                    showText(avatar.jasonHardrail, "Each passenger will need a different kinda dream. Everybody needs somethin', right? So there's different kinds of Dream Bubbles that you'll need to grab for them.")
                    showText(avatar.jasonHardrail, "To draw those Dream Bubbles towards your train, blow the WHISTLE with RIGHT MOUSE BUTTON. This'll attract all kinds of bubbles towards you like a magnet. Now...")
                    showText(avatar.jasonHardrail, "Some vibes out there you don't want. You gotta blow them away! Fire your STEAM CANNON with LEFT MOUSE BUTTON. Use the mouse to aim, too, y'dig?")
                    showText(avatar.jasonHardrail, "Oh, and some tracks'll be better for certain vibes than others, so once you learn your rails you'll be able to give way better dreams.")
                    showTextWithOptions(avatar.jasonHardrail, "Aaaaaaalright. That's pretty much it. That all make sense, kid?" "Kinda?" "...No!")
                    showText(avatar.jasonHardrail, "That's the spirit. Anyway, lets get your first job, lemme check who's up first!")
                    showText(null, "For a few seconds, Jason's eyes roll back into his head and he floats several inches off the platform floor.")
                    showText(avatar.jasonHardrail, "Alright, looks like you're startin' with one of our very own JFIF employees. She'll be nice. Hang around here for a bit, she'll be along soon. Catch you around kid!")
                    ...
                    showText(avatar.luluMomentis, "Uuuh, hey? You're that new conductor right? Jason told me about you with his mind powers.")
                    showText(avatar.luluMomentis, "I'm Lulu Momentis, I work in transcendental metaphoricology, over near finance. Buuuut, today's my day off, so I ain't getting near that damn engine.")
                    showText(avatar.luluMomentis, "I'm looking to have a pretty happy dream, alright? Not too fussed about the intensity, so long as its good vibes all the way down.")
                    showText(avatar.luluMomentis, "Oh, right. Jason probably forgot to mention. There are FOUR TYPES of Dream Bubble, and they come in opposite pairs.")
                    showText(avatar.luluMomentis, "You got YELLOW JUBILANCE and BLUE MISERY, which are self explanatory; Jubilance for happy dreams, Misery for sad ones.")
                    showText(avatar.luluMomentis, "You also RED ANIMOSITY and GREEN INTIMACY. These affect the temperament of the dream.")
                    showText(avatar.luluMomentis, "Just focus on getting those Jubilance bubbles, and make sure you blast any Blue Misery away with your steam cannon.")
                    showTextWithOptions(avatar.luluMomentis, "Alright I really gotta dream. Let's get you on rails!" "Let's go!" "Choo choo, motherfucker!")
